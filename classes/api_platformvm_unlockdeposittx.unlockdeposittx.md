[@c4tplatform/caminojs](../api.md) › [API-PlatformVM-UnlockDepositTx](../modules/api_platformvm_unlockdeposittx.md) › [UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md)

# Class: UnlockDepositTx
...
* [constructor](api_platformvm_unlockdeposittx.unlockdeposittx.md#constructor)

### Properties

* [_codecID](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-_codecid)
* [_outputOwners](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-_outputowners)
* [_typeID](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-_typeid)
* [_typeName](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-_typename)
* [blockchainID](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-blockchainid)
* [ins](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-ins)
* [memo](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-memo)
* [networkID](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-networkid)
* [numins](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-numins)
* [numouts](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-numouts)
* [outs](api_platformvm_unlockdeposittx.unlockdeposittx.md#protected-outs)

### Methods

* [clone](api_platformvm_unlockdeposittx.unlockdeposittx.md#clone)
* [create](api_platformvm_unlockdeposittx.unlockdeposittx.md#create)
* [deserialize](api_platformvm_unlockdeposittx.unlockdeposittx.md#deserialize)
* [fromBuffer](api_platformvm_unlockdeposittx.unlockdeposittx.md#frombuffer)
* [getBlockchainID](api_platformvm_unlockdeposittx.unlockdeposittx.md#getblockchainid)
* [getCodecID](api_platformvm_unlockdeposittx.unlockdeposittx.md#getcodecid)
* [getIns](api_platformvm_unlockdeposittx.unlockdeposittx.md#getins)
* [getMemo](api_platformvm_unlockdeposittx.unlockdeposittx.md#getmemo)
* [getNetworkID](api_platformvm_unlockdeposittx.unlockdeposittx.md#getnetworkid)
* [getOutputOwners](api_platformvm_unlockdeposittx.unlockdeposittx.md#getoutputowners)
* [getOuts](api_platformvm_unlockdeposittx.unlockdeposittx.md#getouts)
* [getTotalOuts](api_platformvm_unlockdeposittx.unlockdeposittx.md#gettotalouts)
* [getTxType](api_platformvm_unlockdeposittx.unlockdeposittx.md#gettxtype)
* [getTypeID](api_platformvm_unlockdeposittx.unlockdeposittx.md#gettypeid)
* [getTypeName](api_platformvm_unlockdeposittx.unlockdeposittx.md#gettypename)
* [sanitizeObject](api_platformvm_unlockdeposittx.unlockdeposittx.md#sanitizeobject)
* [select](api_platformvm_unlockdeposittx.unlockdeposittx.md#select)
* [serialize](api_platformvm_unlockdeposittx.unlockdeposittx.md#serialize)
* [setOutputOwners](api_platformvm_unlockdeposittx.unlockdeposittx.md#setoutputowners)
* [sign](api_platformvm_unlockdeposittx.unlockdeposittx.md#sign)
* [toBuffer](api_platformvm_unlockdeposittx.unlockdeposittx.md#tobuffer)
* [toString](api_platformvm_unlockdeposittx.unlockdeposittx.md#tostring)
* [toStringHex](api_platformvm_unlockdeposittx.unlockdeposittx.md#tostringhex)

## Constructors

###  constructor

\+ **new UnlockDepositTx**(`networkID`: number, `blockchainID`: Buffer, `outs`: [TransferableOutput](api_platformvm_outputs.transferableoutput.md)[], `ins`: [TransferableInput](api_platformvm_inputs.transferableinput.md)[], `memo`: Buffer): *[UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md)*

*Inherited from [UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md).[constructor](api_platformvm_unlockdeposittx.unlockdeposittx.md#constructor)*
...
**Returns:** *[UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md)*
...
• **_typeID**: *number* = PlatformVMConstants.UNLOCKDEPOSITTX

*Overrides [BaseTx](api_platformvm_basetx.basetx.md).[_typeID](api_platformvm_basetx.basetx.md#protected-_typeid)*

*Defined in [src/apis/platformvm/unlockdeposittx.ts:13](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/apis/platformvm/unlockdeposittx.ts#L13)*

___

### `Protected` _typeName

• **_typeName**: *string* = "UnlockDepositTx"

*Overrides [BaseTx](api_platformvm_basetx.basetx.md).[_typeName](api_platformvm_basetx.basetx.md#protected-_typename)*

*Defined in [src/apis/platformvm/unlockdeposittx.ts:12](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/apis/platformvm/unlockdeposittx.ts#L12)*
...
*Defined in [src/apis/platformvm/unlockdeposittx.ts:22](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/apis/platformvm/unlockdeposittx.ts#L22)*
...
*Defined in [src/apis/platformvm/unlockdeposittx.ts:28](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/apis/platformvm/unlockdeposittx.ts#L28)*
...
*Inherited from [UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md).[deserialize](api_platformvm_unlockdeposittx.unlockdeposittx.md#deserialize)*
...
*Inherited from [UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md).[fromBuffer](api_platformvm_unlockdeposittx.unlockdeposittx.md#frombuffer)*
...
*Defined in [src/apis/platformvm/unlockdeposittx.ts:18](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/apis/platformvm/unlockdeposittx.ts#L18)*

Returns the id of the [UnlockDepositTx](api_platformvm_unlockdeposittx.unlockdeposittx.md)
