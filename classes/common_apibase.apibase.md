[camino](../README.md) › [Common-APIBase](../modules/common_apibase.md) › [APIBase](common_apibase.apibase.md)
...
------ | ------ | ------ |
`core` | [CaminoCore](caminocore.caminocore-1.md) | Reference to the Avalanche instance using this baseURL |
