[@c4tplatform/caminojs](../api.md) › [Utils-Payload](../modules/utils_payload.md) › [BMPPayload](utils_payload.bmppayload.md)
...
*Defined in [src/utils/payload.ts:593](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/utils/payload.ts#L593)*
