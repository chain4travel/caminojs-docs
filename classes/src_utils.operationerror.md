[@c4tplatform/caminojs](../api.md) › [src/utils](../modules/src_utils.md) › [OperationError](src_utils.operationerror.md)
...
*Defined in [src/utils/errors.ts:144](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/utils/errors.ts#L144)*
