[@c4tplatform/caminojs](../api.md) › [Utils-Payload](../modules/utils_payload.md) › [IPFSPayload](utils_payload.ipfspayload.md)
...
*Defined in [src/utils/payload.ts:668](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/utils/payload.ts#L668)*
