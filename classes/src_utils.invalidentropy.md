[@c4tplatform/caminojs](../api.md) › [src/utils](../modules/src_utils.md) › [InvalidEntropy](src_utils.invalidentropy.md)
...
*Defined in [src/utils/errors.ts:340](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/utils/errors.ts#L340)*
