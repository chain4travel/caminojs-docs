[@c4tplatform/caminojs](../api.md) › [src/utils](../modules/src_utils.md) › [ChainIdError](src_utils.chainiderror.md)
...
*Defined in [src/utils/errors.ts:74](https://github.com/chain4travel/caminojs/blob/ac57b5af/src/utils/errors.ts#L74)*
